...
public class RegisterRestaurantActivity extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    private EditText edtName, edtOpen, edtClose, edtAdress, edtPhone, edtWeb, edtLogo;
    ...
    public void onClick(View v) {
        ...
        if (name.isEmpty() || open.isEmpty() || close.isEmpty() || address.isEmpty() || phone.isEmpty() || web.isEmpty() || logo.isEmpty()){
